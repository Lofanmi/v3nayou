...
var (
	cfgs = map[string]interface{}{
		...
		"gzhu.icons.others": []map[string]string{
			...
			map[string]string{"name": "参与开发", "link": "dev", "icon": "/static/icons/dev.png"},
		},
		...
		"sysu.icons.others": []map[string]string{
			map[string]string{"name": "公选排行榜", "link": "http://www.courstack.com/course/sysu", "icon": "/static/icons/tel.png"},
			map[string]string{"name": "参与开发", "link": "dev", "icon": "/static/icons/dev.png"},
		},
